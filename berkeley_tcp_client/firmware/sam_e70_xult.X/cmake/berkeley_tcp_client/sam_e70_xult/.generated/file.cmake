...
set(berkeley_tcp_client_sam_e70_xult_sam_e70_xult_XC32_FILE_TYPE_assemble)
set_source_files_properties(${berkeley_tcp_client_sam_e70_xult_sam_e70_xult_XC32_FILE_TYPE_assemble} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${berkeley_tcp_client_sam_e70_xult_sam_e70_xult_XC32_FILE_TYPE_assemble})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(berkeley_tcp_client_sam_e70_xult_sam_e70_xult_XC32_FILE_TYPE_assembleWithPreprocess)
set_source_files_properties(${berkeley_tcp_client_sam_e70_xult_sam_e70_xult_XC32_FILE_TYPE_assembleWithPreprocess} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${berkeley_tcp_client_sam_e70_xult_sam_e70_xult_XC32_FILE_TYPE_assembleWithPreprocess})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(berkeley_tcp_client_sam_e70_xult_sam_e70_xult_XC32_FILE_TYPE_compile
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../../src/app.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../../src/app_commands.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../../src/config/default/driver/gmac/src/dynamic/drv_gmac_lib_samE7x_V7x.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../../src/config/default/peripheral/mpu/plib_mpu.c"
...
set_source_files_properties(${berkeley_tcp_client_sam_e70_xult_sam_e70_xult_XC32_FILE_TYPE_compile} PROPERTIES LANGUAGE C)
set(berkeley_tcp_client_sam_e70_xult_sam_e70_xult_XC32_FILE_TYPE_compile_cpp)
set_source_files_properties(${berkeley_tcp_client_sam_e70_xult_sam_e70_xult_XC32_FILE_TYPE_compile_cpp} PROPERTIES LANGUAGE CXX)
set(berkeley_tcp_client_sam_e70_xult_sam_e70_xult_XC32_FILE_TYPE_link)

# The linker script used for the build.
set(berkeley_tcp_client_sam_e70_xult_LINKER_SCRIPT "${CMAKE_CURRENT_SOURCE_DIR}/../../../../src/config/default/ATSAME70Q21B.ld")
set(berkeley_tcp_client_sam_e70_xult_image_name "sam_e70_xult.elf")
set(berkeley_tcp_client_sam_e70_xult_image_base_name "sam_e70_xult")

# The output directory of the final image.
set(berkeley_tcp_client_sam_e70_xult_output_dir "${CMAKE_CURRENT_SOURCE_DIR}/../../../out/berkeley_tcp_client")

# The full path to the final image.
set(berkeley_tcp_client_sam_e70_xult_full_path_to_image ${berkeley_tcp_client_sam_e70_xult_output_dir}/${berkeley_tcp_client_sam_e70_xult_image_name})
